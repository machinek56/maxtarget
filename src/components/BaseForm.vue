<template>
  <div>
    ...
    <form>
      ...
      <div class="form-group">
        <label class="form-label" for="account">Имя аккаунта или ссылка на сайт:</label>
        <input type="text"
               v-model="account"
               class="form-control"
               id="account"
      ...
      <button type="submit"
              ...
              :disabled="!submitModalBtnAvailable || pendingRequest"
      >
          <loading v-if="pendingRequest"></loading>
          Отправить
      </button>
    </form>
  </div>
